<template>
    ...
    >
        ...
        <dt class="hidden">Explorer Montpellier avec les différents moyen de transport proposés comme les bus , les
            trams ,
        ...
        <template v-if="enabledBike">
            ...
            >
                ...
                <!-- Pop Up avec les données des stations vélos -->
                <l-popup>
                    <h2>
                        Nombre de vélo disponible : {{ marker.bike_available }} <br>
